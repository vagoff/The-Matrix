...
static uw_Basis_int __uwn_$c_1099(uw_context, uw_Basis_int);
static uw_Basis_int __uwn_$d_1100(uw_context, uw_Basis_int);
static uw_Basis_int __uwn_$c_1099(uw_context ctx, uw_Basis_int __uwr_n_0)
{
    return((
    {
        ...
        result;
        {
            ...
            if (disc0 != 0LL) goto L6;
            result = (__uwn_$d_1100(ctx, __uwr_n_0)) + 10LL;
            goto L5;
        }
L6:
        {

            if (disc0 != 1LL) goto L7;
            result = (__uwn_$c_1099(ctx, __uwr_n_0)) + 20LL;
            goto L5;
        }
L7:
        {

            if (disc0 != 2LL) goto L8;
            result = 20LL;
            goto L5;
        }
L8:
        {
            ...
            result = __uwn_$d_1100(ctx, __uwr_n_0 - 1LL);
            goto L5;
        }
L9:
        uw_error(ctx, FATAL, "/mnt/sources/ur/tce2.ur:3:11-9:1: pattern match failure");
L5: result;
    }));
}

static uw_Basis_int __uwn_$d_1100(uw_context ctx, uw_Basis_int __uwr_m_0)
{
    return((
    {
        ...
        result;
        {
            ...
            result = (__uwn_$c_1099(ctx, __uwr_m_0)) + 30LL;
            goto L0;
        }
L1:
        {

            if (disc0 != 1LL) goto L2;
            result = (__uwn_$d_1100(ctx, __uwr_m_0)) + 40LL;
            goto L0;
        }
L2:
        {

            if (disc0 != 2LL) goto L3;
            result = 30LL;
            goto L0;
        }
L3:
        {
            ...
            result = __uwn_$c_1099(ctx, __uwr_m_0 - 1LL);
            goto L0;
        }
L4:
        uw_error(ctx, FATAL, "/mnt/sources/ur/tce2.ur:9:11-14:4: pattern match failure");
L0: result;
    }));
}
...
__uwn_wrap_main_1102(uw_context ctx, uw_Basis_int __uwr_x0_0,
    ...
    ((uw_write(ctx, uw_Basis_maybe_onunload(ctx, "")), uw_unit_v),
     ((uw_write(ctx, ">"), uw_unit_v),
      ((uw_write(ctx, uw_Basis_get_script(ctx, ( { struct __uws_0 tmp =
       ...
       (uw_Basis_htmlifyInt_w(ctx, __uwn_$c_1099(ctx,
                              __uwr_x0_0 + 10LL)),
...
static void uw_handle(uw_context ctx, char *request)
{
    if (!strcmp(request, "/app.js"))
    {
        ...
        if (ims && !strcmp(ims, "Sun, 02 Jan 2011 23:03:04"))
        {
        ...
        uw_write_header(ctx, "Last-modified: Sun, 02 Jan 2011 23:03:04\r\n");
        uw_write(ctx, jslib);
        return;
    }
    if (!strncmp(request, "/Tce2/main", 10) && (request[10] == 0 || request[10] == '/'))
    {
        request += 10;
        if (*request == '/') ++request;
